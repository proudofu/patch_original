...
Prefs = struct('matlab_exec_path','MATLAB.exe -minimize -nosplash  -r',...  % -nodisplay  -nodesktop -minimize -noawt -noFigureWindows path for launching child matlab processess 
    ...
    'MinCopperRingArea',100, ...                    % 67 mm^2 min area of the copper-ring paper 28x28mm2 window with  0.586mm rim window
    'MaxCopperRingArea',101, ...                   % 120 mm^2 max area of the copper-ring paper 28x28mm2 window with  0.586mm rim window
...
Prefs.NumCPU = 2; %str2num(getenv('NUMBER_OF_PROCESSORS'))-4; % number of CPUs that can be used 
