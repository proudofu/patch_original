function [Prefs, actually_defined_flag] = patch_define_preferences(Prefs)
...
Prefs.NumCPU = 1; % In order to bypass child processes and make compatible with cluster environment
