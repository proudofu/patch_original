function procFrame = patch_master_process_movie_frames(MovieName, localpath, FilePrefix, Ring, stimulusfile, startFrame, endFrame, target_numworms)
...
if(isempty(Ring.NumWorms) || isempty(Ring.DefaultThresh) || isempty(Ring.meanWormSize))
    [DefaultLevel, NumFoundWorms, mws, Ring] = patch_default_worm_threshold_level(MovieName, background, procFrame, target_numworms, Ring);
...
procFrame = patch_process_movie_frames(MovieName, background, Ring, procFrame);
