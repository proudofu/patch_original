function patch_process_movie_frames(MovieName,localpath, FilePrefix, stimulusfile, startFrame, endFrame, target_numworms)
...
% Trying to de-hack all of the above commands
load(RingFile); %#ok
Prefs=[];
